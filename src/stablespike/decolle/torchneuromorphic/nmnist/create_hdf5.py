...
def nmnist_get_file_names(dataset_path):
    ...
    for digit in range(10):
        ...
        digit_test = glob.glob(os.path.join(dataset_path, 'Test', str(digit), '*.bin'))
    ...
    print("N-MNIST: {} train samples and {} test samples per digit (max: {} train and {} test)".format(
        n_train, n_test, max_n_train, max_n_test
    ))
